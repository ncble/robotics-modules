...
MAX_STEPS = 250  # Number of steps before termination
...
class LabyrinthEnv(BaseEnv):
    ...
    def __init__(self, renders=False, is_discrete=True,
                 name="Labyrinth", shape_reward=False, record_data=False, srl_model="raw_pixels",
                 random_target=False, state_dim=-1, verbose=False, save_path='./data/',
    ...
    def create_map(self):
        ...
        # load images
        target_img_ori = cv2.imread("./env_module/labyrinth/tresors_128.png")
        robot_img_ori = cv2.imread("./env_module/labyrinth/corsair_128.png")
